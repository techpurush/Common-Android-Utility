...
public class LinkUtils {
    ...
    public static boolean isGMSExists(@NonNull Context context) {
        return PackageUtils.isPackageExists(context, PACKAGE_GMS);
    }
    ...
    public static boolean isGoogleFeedbackExists(@NonNull Context context) {
        return PackageUtils.isPackageExists(context, PACKAGE_FEEDBACK);
    }
    ...
    public static void feedback(@NonNull Context context,
        ...
        report.systemApp = PackageUtils.isSystemApp(context.getApplicationInfo());
