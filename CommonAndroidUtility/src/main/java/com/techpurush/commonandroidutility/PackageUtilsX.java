...
import com.techpurush.commonandroidutility.ShellUtils.CommandResult;
 ...
 * <li>{@link PackageUtilsX#installNormal(Context, String)}</li>
 * <li>{@link PackageUtilsX#installSilent(Context, String)}</li>
 * <li>{@link PackageUtilsX#install(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link PackageUtilsX#uninstallNormal(Context, String)}</li>
 * <li>{@link PackageUtilsX#uninstallSilent(Context, String)}</li>
 * <li>{@link PackageUtilsX#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link PackageUtilsX#isSystemApplication(Context)}</li>
 * <li>{@link PackageUtilsX#isSystemApplication(Context, String)}</li>
 * <li>{@link PackageUtilsX#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link PackageUtilsX#getInstallLocation()} get system install location</li>
 * <li>{@link PackageUtilsX#isTopActivity(Context, String)} whether the app whost
 * package's name is packageName is on the top of the stack</li>
 * <li>{@link PackageUtilsX#startInstalledAppDetails(Context, String)} start
 * InstalledAppDetails Activity</li>
 * </ul>
 *
 * @author jingle1267@163.com
 */
public final class PackageUtilsX {

    public static final String TAG = "PackageUtilsX";
    ...
    public static final int install(Context context, String filePath) {
        if (PackageUtilsX.isSystemApplication(context)
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link PackageUtilsX#INSTALL_SUCCEEDED} means install success,
     * other means failed. details see {@link PackageUtilsX}
