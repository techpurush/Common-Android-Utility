...
public final class JSONUtilsX {
    ...
    public static Long getLong(JSONObject jsonObject, String key, Long defaultValue) {
        if (jsonObject == null || StringUtilsX.isEmpty(key)) {
            return defaultValue;
        }
     ...
     *         <li>return {@link JSONUtilsX#getLong(JSONObject, String, Long)}</li>
     *         </ul>
     */
    public static Long getLong(String jsonData, String key, Long defaultValue) {
        if (StringUtilsX.isEmpty(jsonData)) {
            return defaultValue;
        }
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getLong(JSONObject, String, Long)
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getLong(String, String, Long)
     */
    public static long getLong(String jsonData, String key, long defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getInt(JSONObject, String, Integer)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getInt(JSONObject, String, Integer)
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getInt(String, String, Integer)
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getDouble(JSONObject, String, Double)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getDouble(JSONObject, String, Double)
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see JSONUtilsX#getDouble(String, String, Double)
     */
    public static double getDouble(String jsonData, String key, double defaultValue) {
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getString(JSONObject, String, String)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getStringArray(JSONObject, String, String[])}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getStringList(JSONObject, String, List)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonData is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getJSONObject(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getJSONArray(JSONObject, String, JSONArray)}</li>
     *         </ul>
     */
     ...
     *         <li>if jsonObject is null, return defaultValue</li>
     *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     *         <li>return {@link JSONUtilsX#getBoolean(JSONObject, String, Boolean)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link JSONUtilsX#parseKeyAndValueToMap(String)}</li>
     *         </ul>
     */
    public static Map<String, String> getMap(JSONObject jsonObject, String key) {
        return JSONUtilsX.parseKeyAndValueToMap(JSONUtilsX.getString(jsonObject, key, null));
    }
     ...
     *         <li>return {@link JSONUtilsX#getMap(JSONObject, String)}</li>
     *         </ul>
     */
     ...
     *         <li>return {@link JSONUtilsX#parseKeyAndValueToMap(JSONObject)}</li>
     *         </ul>
     */
    public static Map<String, String> parseKeyAndValueToMap(String source) {
        if (StringUtilsX.isEmpty(source)) {
            return null;
        }
